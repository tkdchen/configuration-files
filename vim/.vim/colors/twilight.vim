...
exe 'hi Identifier     guifg='.s:grey_blue         .' guibg='.s:darkgrey        .' gui=bold'
...
exe 'hi Structure      guifg='.s:beige             .' guibg='.s:darkgrey        .' gui=bold'
exe 'hi Function       guifg='.s:violet            .' guibg='.s:darkgrey        .' gui=bold'
