...
" status line
hi StatusLine	guifg=#88ee99	guibg=black	gui=bold
hi StatusLineNC	guifg=#446644	guibg=black	gui=bold
...
" Procedure name
hi Function     guifg=#ffaa33			gui=bold
...
hi Todo		guifg=pink	guibg=black	gui=bold
