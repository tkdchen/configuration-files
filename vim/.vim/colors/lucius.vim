...
" if, then, else
hi Conditional      guifg=#b3d38c                                   gui=bold
hi Conditional      ctermfg=150                                     cterm=bold
" try, catch, throw, raise
hi Exception        guifg=#b3d38c                                   gui=bold
hi Exception        ctermfg=150                                     cterm=bold
" for, while, do
hi Repeat           guifg=#b3d38c                                   gui=bold
hi Repeat           ctermfg=150                                     cterm=bold
" case, default
...
" any other keyword
hi Keyword          guifg=#b3d38c                                   gui=bold
hi Keyword          ctermfg=150                                     cterm=bold
